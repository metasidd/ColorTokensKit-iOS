...
public extension LCHColor {
    ...
    var _5: Color {
        Color(
            light: LCHColor(l: 95, c: 15, h: self.h).toColor(),
    ...
    var _15: Color {
        Color(
            light: LCHColor(l: 85, c: 25, h: self.h).toColor(),
    ...
    var _25: Color {
        Color(
            light: LCHColor(l: 75, c: 32, h: self.h).toColor(),
    ...
    var _45: Color {
        Color(
            ...
            dark: LCHColor(l: 43, c: 40, h: self.h).toColor())
    }

    var _50: Color {
        Color(
            light: LCHColor(l: 50, c: 30, h: self.h).toColor(),
            dark: LCHColor(l: 47, c: 40, h: self.h).toColor())
    }

    var _55: Color {
        Color(
            light: LCHColor(l: 45, c: 35, h: self.h).toColor(),
            dark: LCHColor(l: 50, c: 43, h: self.h).toColor())
    }

    var _60: Color {
        Color(
            light: LCHColor(l: 40, c: 40, h: self.h).toColor(),
            dark: LCHColor(l: 53, c: 45, h: self.h).toColor())
    }

    var _65: Color {
        Color(
            light: LCHColor(l: 35, c: 45, h: self.h).toColor(),
            dark: LCHColor(l: 56, c: 47, h: self.h).toColor())
    }

    var _70: Color {
        Color(
            light: LCHColor(l: 30, c: 50, h: self.h).toColor(),
            dark: LCHColor(l: 59, c: 50, h: self.h).toColor())
    }

    var _75: Color {
        Color(
            light: LCHColor(l: 25, c: 55, h: self.h).toColor(),
            dark: LCHColor(l: 62, c: 53, h: self.h).toColor())
    }

    var _80: Color {
        Color(
            light: LCHColor(l: 20, c: 60, h: self.h).toColor(),
            dark: LCHColor(l: 65, c: 55, h: self.h).toColor())
    }

    var _85: Color {
        Color(
            light: LCHColor(l: 15, c: 75, h: self.h).toColor(),
            dark: LCHColor(l: 68, c: 60, h: self.h).toColor())
    }

    var _90: Color {
        Color(
            light: LCHColor(l: 10, c: 80, h: self.h).toColor(),
            dark: LCHColor(l: 72, c: 63, h: self.h).toColor())
    }

    var _95: Color {
        Color(
            light: LCHColor(l: 5, c: 85, h: self.h).toColor(),
            dark: LCHColor(l: 76, c: 65, h: self.h).toColor())
    }

    var _100: Color {
        Color(
            light: LCHColor(l: 0, c: 90, h: self.h).toColor(),
            dark: LCHColor(l: 80, c: 70, h: self.h).toColor())
    }
}
